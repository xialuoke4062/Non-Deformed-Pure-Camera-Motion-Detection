            ...
            while video_fp.isOpened():
                ...
                if prev_frame is not None:
                    ...
                    cv2.calcOpticalFlowFarneback(prev=prev_gray, next=cur_gray, flow=opt_flow, pyr_scale=0.5,
                                                 levels=3, winsize=10, iterations=3, poly_n=5, poly_sigma=1.1,
                                                 flags=0)
                    ...
                    # hsv[..., 1] = 255
                    # flow = cv2.calcOpticalFlowFarneback(prev=prev_gray, next=cur_gray, flow=opt_flow,
...
if __name__ == "__main__":
    ...
    """Video Loading Path"""
    video_root = Path("/Users/xwang169/Downloads/videos/A")
